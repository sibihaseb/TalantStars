            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Customize how your profile information is displayed</CardDescription>
                </CardHeader>
                <CardContent>
                  <Tabs defaultValue="profile-image" className="space-y-6">
                    <TabsList className="grid w-full grid-cols-2">
                      <TabsTrigger value="profile-image" className="flex items-center gap-2">
                        <User className="w-4 h-4" />
                        Profile Image
                      </TabsTrigger>
                      <TabsTrigger value="display-options" className="flex items-center gap-2">
                    ...
                    <TabsContent value="profile-image" className="space-y-6">
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>Upload your main profile photo (1:1 ratio)</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <TabsContent value="display-options" className="space-y-6">
                      <Card>
                        <CardHeader>
                          <CardTitle className="flex items-center space-x-2">
                        ...
                        <CardContent className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between">
                              <div>
                                <Label className="font-medium">Show Experience Timeline</Label>
                                <p className="text-sm text-gray-500">Display your work history timeline</p>
                              </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                <Label className="font-medium">Show Skills Section</Label>
                                <p className="text-sm text-gray-500">Display your professional skills</p>
                              </div>
                              <Switch defaultChecked />
                            </div>
                          </div>
                          ...
                          <div className="border-t pt-6">
                            <div className="mb-4">
                              ...
                              <p className="text-sm text-gray-500">Manage your social media presence and links</p>
                            </div>
                            <SocialMediaManager />
                          </div>
                        </CardContent>
